...
class ProbeResult(Base):
    ...
    expected_slide = Column(Integer, nullable=True)
    slide_answer   = Column(Integer, nullable=True)
    slide_passed   = Column(Boolean, nullable=True)
    camera_passed  = Column(Boolean, nullable=True)   # ← this new one
